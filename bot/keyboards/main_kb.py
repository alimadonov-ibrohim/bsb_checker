...
def main_menu_kb() -> ReplyKeyboardMarkup:
    return ReplyKeyboardMarkup(
        keyboard=[
            ...
            [KeyboardButton(text="⭐ Ballar"), KeyboardButton(text="📄 O‘quvchilar javoblari")],
            [KeyboardButton(text="📊 Natijalar"), KeyboardButton(text="📥 Excel")],
...
def results_list_kb(test_id: int) -> InlineKeyboardMarkup:
    return InlineKeyboardMarkup(
        inline_keyboard=[
            [
                InlineKeyboardButton(text="🔍 Javoblar", callback_data=f"detail:{test_id}"),
            ...
            [
                ...
                InlineKeyboardButton(text="⭐ Ballar", callback_data=f"points:{test_id}"),
            ],
            [InlineKeyboardButton(text="◀️ Orqaga", callback_data="back_main")],
        ]
    )
